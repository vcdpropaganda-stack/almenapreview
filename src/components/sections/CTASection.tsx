      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-off-white hover:bg-sand text-accent font-medium px-10 py-5 rounded-lg text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
